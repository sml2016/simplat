...
'Patrocinadores5' => 'SPONSHORSHIP   BRONZE',
    'Beneficios5' => '<li><i class="fa fa-heart"></i>Name placement in event program.</li>',
      ...
      'MesasInfo' => '<h1>Exhibitor Tables</h1>
                      <p>We offer exhibitor tables in high traffic places during the Third Latina’s Symposium. Come and join us. You can maximize your business potential and your presence in the community, making connections face-to-face through the Latina’s Symposium.</p>
                      <p>To reserve your space or get more information, contact us at <span class="mesa">simposiomujereslatina.media@gmail.com</span></p>',
      'comoDonar' => ' <h1>Your donations matter</h1>
                     ...
                     <p>Remember to print the receipt for your files.</p>',
   'hacerDonaciones' => '<h1>Want to help and have no money?</h1>     
                     <p>We are happy to receive your support to the Latina Symposium, no matter if you’ve money or not.</p>
                     <p> You can donate gift card for any amount for groceries, online shopping, among others. To get more information about how can you help us, please contact us by email: <span>simposiomujereslatinas@gmail.com</span></p>'
];