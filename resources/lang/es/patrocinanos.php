...
'Patrocinadores4' => 'PATROCINADOR  PLATA',
   'Beneficios4' => '<li><i class="fa fa-heart-o"></i>Agradecimiento en el programa del evento.</li>
...
'hacerDonaciones' => '<h1>¿Quieres apoyar pero no tienes dinero para donaciones?</h1>     
