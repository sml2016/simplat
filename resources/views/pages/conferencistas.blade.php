            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-7 col-md-6 col-lg-6">
                   ...
                   <!---Primer Conferencista--->     
                        ...
                        <h3>Latino Advocacy</h3>
                        <h4>Puño de Oro 2016</h4>
                        <p>English writer Virginia Woolf was raised in a remarkable househont figures in the golden age of mountaineering. e Jackson), had been 
                           ...
                           the girls were taught at hs were extremely wy. Her father was a friend to William Thackeray and George Henry Lewes, as 
                    </p>
                    </div>
                </div>
             ...
             <div class="row">
                ...
                <div class="col-xs-12 col-sm-7 col-md-6 col-lg-6">
                    <div class="conferencistas1a">
                        ...
                        <h3>Activista</h3>
                        <p>English writer Virginia Woolf was raised in a remarkable household. Her father, Sir Leslie Stephen, was an historian and author, and also one of the most prominent figures in the golden age of mountaineering. Woolf’s mother, Julia Prinsep Stephen (née Jackson), had been born in India and later served as a model for several Pre-Raphaelite painters. 
                            <div id="leermas" class="visible-xs visible-sm hidden-md hidden-lg">
                                <button type="button" class="btn btn-leer btn-sm">Leer más</button>
                            </div>
                            Two of Woolf’s brothers had been educated at Cambridge, but all the 
