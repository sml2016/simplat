        ...
        <div class="collapse navbar-collapse navbar-right">
            <div class="menu1">
                <ul class="nav navbar-nav">
                    ...
                    <li class="visible-xs"><a href="{{ url('/contacto') }}"><span class="active1">{{ trans('header.Contacto') }}</a></li>
                </ul>
            </div>
            <!--End menu1 -->
            <!--Menu Principal 2 -->
            <div class="menu2 hidden-xs">
                <div class="navbar-right">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="{{ url('/contacto') }}"><span class="active1">{{ trans('header.Contacto') }}</a></li>
                    </ul>
                </div>
            </div> <!--End menu2 -->
        </div>
